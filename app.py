    ...
    if len(testable_cols) < 2:
        ...
        if sweep_result is None:
            ...
            if not significant_rows:
                ...
                # easy to skim past; underpowered t-test/chi-square findings
                # get a plain-English callout with a concrete follow-up
                # sample size, same "don't just flag it, tell them what to
                # do next" pattern as the confounder cross-check below.
                underpowered_rows = [
