...
_DEFAULTS = {
    ...
    "anomaly_narration": None,  # Gemini narration of the current anomaly result
    "anomaly_narration_fingerprint": None,  # anomaly.anomaly_fingerprint() the cached narration belongs to
        ...
        if not anomaly.is_available():
            ...
            if st.session_state.anomaly_error:
                ...
                if flagged.empty:
                    ...
                    current_fp = anomaly.anomaly_fingerprint(flagged)
                    if (
                        ...
                        if st.button(
                            "✨ Narrate these anomalies",
                            key="narrate_anomalies_btn",
                            help="Ask Gemini to explain what's unusual and suggest a next step",
                        ):
                            model = ai_analyst.get_model()
